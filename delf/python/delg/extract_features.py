...
############################################ NOTE #######################################
#   If you're having trouble building wheels for opencv-python or opencv-python-headless,
#   try pip install opencv-python==4.3.0.36, pip install opencv-python-headless==4.2.0.34
#########################################################################################
...
def main(argv):
  ...
  query_list, index_list, ground_truth = dataset.ReadDatasetFile(FLAGS.dataset_file_path, ox_paris = False)
  ...
  for i in range(num_images):
    ...
    resize_factor = 1.0
    if FLAGS.image_set == 'query' and ground_truth is not None:
